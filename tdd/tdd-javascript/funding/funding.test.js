...
describe("Testing FundInfo functionality",()=>{
    ...
    it("does constructor store the data in variable",()=>{

        let fundInstance = new FundInfo();
        expect(fundInstance.fundData).toBe(require('./startup-funding.json'));
    });
    ...
    it("findBy function returns an empty object when non-string parameters are passed",()=>{

        const companyName = 123;
        const city = "San Francisco";

        let fundInstance = new FundInfo();
        expect(fundInstance.findBy(companyName)).toStrictEqual({});
    });
