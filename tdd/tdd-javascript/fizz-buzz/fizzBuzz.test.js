...
describe("Testing FizzBuzz functionality",()=>{
    ...
    it("does FizzBuzz class exists?",()=>{

        let mulInstance = new FizzBuzz();
    ...
    it("does print function returns FizzBuzz for number which is a FizzBuzz of 3 and 5",()=>{
    ...
    it("does print function returns Fizz for number which is a FizzBuzz of 3 only",()=>{
    ...
    it("does print function returns Buzz for number which is a FizzBuzz of 5 only",()=>{
